...
const displayContent = (text) => {
    return text.length <1 ? 'text' : text.slice(0, 30) + "<span class='fw-bold'>... read more</span>";
};
              ...
              <div class="post__header">
                <div class="post__profile">
                  <a
                    ...
                    class="post__avatar"
                  >
                    <img src="/photo/WhatsApp Image 2021-08-29 at 1.14.21 PM.jpeg" alt="User Picture" />
                  </a>
